...
int main ()
{
  ...
  **/
  PID pid_steer = PID();
  pid_steer.Init(0.25, 0.001, 0.7, 1, -1);
  ...
  **/
              ...
              char *data, size_t length, uWS::OpCode opCode)
  {
        ...
        if (s != "") {
          ...
          **/
          //error_steer = (waypoint_x - x_position) / new_delta_time;
          ...
          // The car should steer it's direction based on the yaw angle of car and the angle of current position and next point
          // of the planned path. I visualized it at https://github.com/kimbring2/nd013-c6-control-starter/blob/main/images/pid_steer_reason.png  
